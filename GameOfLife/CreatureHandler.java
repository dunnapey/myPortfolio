...
public class CreatureHandler
{
	...
	List<Creature> babyList = new ArrayList<Creature>();
	...
	*/
	...
	/**
	* Updates all of the living creatures in the game by making them each get a chance to
